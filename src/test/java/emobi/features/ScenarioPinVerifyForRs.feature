...
Feature: Pin verify flow type MSISDN + PIN Functionality
  ...
  Scenario: User GET pin verify flow MSISDN + PIN of RS Country unsuccessful with pin invalid mandatory credentials
    ...
    Then Response successful status code is 400 after pin verify of flow msisdn pin with pin invalid mandatory
