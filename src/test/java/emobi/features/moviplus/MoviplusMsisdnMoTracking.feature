...
Feature: Tracking request Moviplus flow type MSISDN + MO Functionality
  ...
  Scenario: User GET tracking request affiliates partner Moviplus flow MSISDN + MO of AT country successful with valid credentials
    ...
    Then Response successful status code is 200 after tracking request of Moviplus flow msisdn mo
  ...
  Scenario: User GET tracking request affiliates partner Moviplus flow MSISDN + MO of AT country successful with invalid mandatory credentials
    ...
    Then Response successful status code is 400 after tracking request of Moviplus flow msisdn mo invalid mandatory credentials
