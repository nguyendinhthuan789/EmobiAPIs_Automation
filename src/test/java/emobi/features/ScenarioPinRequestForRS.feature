...
Feature: Pin request flow type MSISDN + PIN Functionality
  ...
  Scenario: User GET pin request flow MSISDN + PIN of RS Country unsuccessful with invalid mandatory credentials
    ...
    Then Response successful status code is 400 after pin request of flow msisdn pin with invalid mandatory
