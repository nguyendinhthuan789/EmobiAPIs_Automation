...
Feature: Tracking request Adpeako flow type C2S Functionality
  ...
  Scenario: User GET tracking request affiliates partner Adpeako flow C2S of BA - Eronet successful with valid credentials
    ...
    Then Response successful status code is 200 after tracking request of Adpeako flow C2S ba eronet
  ...
  Scenario: User GET tracking request affiliates partner Adpeako flow C2S of BA - Mtel successful with valid credentials
    ...
    Then Response successful status code is 200 after tracking request of Adpeako flow C2S ba mtel
