...
Feature: Pin verify Mobwizard flow type MSISDN + PIN Functionality
  ...
  Scenario: User GET pin verify affiliates partner Mobwizard flow MSISDN + PIN of RS Country successful with valid credentials
    ...
    | 3525c3c2d-79ba-4e5c-9b82-74861aba0a30 | 5g043028b301065041111 |  sYhM3076631618314366  |  3333 |
  ...
  Scenario: User GET pin verify affiliates partner Mobwizard flow MSISDN + PIN of RS Country successful with pin invalid credentials
    Given User call the API pin verify of Mobwizard flow msisdn pin with pin invalid credential
      | campaignID  | tpClickId | pinId |  pinValue |
      | 3525c3c2d-79ba-4e5c-9b82-74861aba0a30 | 5g043028b301065041111 |  sYhM3076631618314366  |  1111 |
  ...
  Scenario: User GET pin verify affiliates partner Mobwizard flow MSISDN + PIN of RS Country successful with pin invalid mandatory credentials
