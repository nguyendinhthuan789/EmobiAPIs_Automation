...
Feature: Pin request Mobwizard flow type MSISDN + PIN Functionality
  ...
  Scenario: User GET pin request affiliates partner Mobwizard flow MSISDN + PIN of RS Country successful with invalid campaign credentials
  ...
  Scenario: User GET pin request affiliates partner Mobwizard flow MSISDN + PIN of RS Country successful with invalid mandatory credentials
