...
public class EdanC2sController {
    Logger log = LoggerFactory.getLogger(EdanC2sController.class);
    ...
    public void edanRequestC2STracking(List<List<String>> list) {
    ...
    public void verifyResponseEronetWithInvalidInput(List<List<String>> list) {
        result = Utils.generateListString(list);
    ...
    public void verifyResponseMtelWithInvalidInput(List<List<String>> list) {
        result = Utils.generateListString(list);
        log.info("message is: " + findJsonPathHasKey("message"));
        Assert.assertEquals(result.get(4), findJsonPathHasKey("message"));
        log.info("status is: " + findJsonPathHasKey("status"));
