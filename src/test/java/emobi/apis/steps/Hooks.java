package emobi.apis.steps;

import emobi.apis.constants.Constants;
...
public class Hooks implements ConcurrentEventListener {
    ...
    private EventHandler<TestRunFinished> afterAll = event -> {
        Helper.createEnvironmentProperties(enviromentPropertiesPath);
